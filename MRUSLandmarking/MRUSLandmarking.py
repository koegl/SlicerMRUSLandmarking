...
class LandmarkIO:
  ...
  def load_numpy_landmarks(self):
    ...
    file_path = "/Users/fryderykkogl/Data/landmarks/ag2146_T2SPACE_US1predura"
    ...
    for j in range(landmarks[0].shape[0]):
      for i in range(2):
        cors = landmarks[i][j]
        markup_node.AddFiducial(cors[0], cors[1], cors[2],
                                "{}_{}".format(file_name[i + 1], j))  # +1 because 0th is AG
